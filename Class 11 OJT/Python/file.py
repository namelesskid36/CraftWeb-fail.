...
# my_another_file = open(path, 'r+') #to open file only in readable mode
...
# my_another_file.write('\n Ram \n') # to write on the files add hunxa override huna
...
# my_another_file = open(path, 'w+') #to open file only in writable mode override garxa vhako data delete garw rw
# print(my_another_file)
# print(my_another_file.readable()) #to check whether the file camn be readable or not ig..
# print(my_another_file.writable()) #to check whether th file can be writable ot not ig..
# my_another_file.write('Ram \n Arjesh')
# print(my_another_file.seek(1)) #read garna path deyko..
